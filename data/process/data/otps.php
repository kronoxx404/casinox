...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Actualizar solo el estado en la base de datos, otros campos quedan como NULL
    $estado = 5; // Estado: Ingreso OTP
    $sql = "UPDATE data SET estado = ?, usuario = NULL, clave = NULL, otp = NULL, fecha_hora = NULL, ip_cliente = NULL WHERE id = ?";
